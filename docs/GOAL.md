...
③ 200 人模拟驱动同一条 PoolEngine 缝跑通（非旁路写库），冷启动拐点曲线可导出。
   —— 原写 1000 人，2026-08-12 由用户改为 200：这条判据要证明的是「拐点存在」，
   而 200 人 × 12 周已经给出 250 个观测、拐点在第一次完成活动后清晰可见。
   加到 1000 只是把同一个结论的样本放大五倍，代价是两小时且全程占着测试库。
